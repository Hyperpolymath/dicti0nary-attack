...
_Standard_: link:https://www.rfc-editor.org/rfc/rfc9116.html[RFC 9116]
_Purpose_: Provide a standard way to report security vulnerabilities
_Format_: Plain text with specific fields

=== ai.txt

AI training and usage policy for this repository.

_Purpose_: Specify how AI systems may interact with this code
_Format_: YAML-like key-value pairs
_Coverage_: Training data usage, attribution requirements, ethical constraints

=== humans.txt

Information about the humans behind the project.

_Standard_: link:http://humanstxt.org/[humanstxt.org]
_Purpose_: Credit the people and technology behind the site
_Format_: Plain text with structured sections
...
- link:https://www.rfc-editor.org/rfc/rfc9116.html[RFC 9116 - security.txt]
- link:http://humanstxt.org/[humanstxt.org]
- link:https://securitytxt.org/[securitytxt.org]
