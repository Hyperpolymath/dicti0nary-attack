...
* Using the tool for unauthorized or illegal purposes
* Sharing exploits or vulnerabilities publicly before coordinated disclosure
* Promoting unethical hacking or unauthorized access
...
This Code of Conduct also applies to the _use_ of the tool itself. Users must:
- Only use the tool for authorized, legal purposes
- Obtain explicit written permission before testing systems
- Report vulnerabilities responsibly
- Not use the tool to harm others or violate laws
...
== Security Tool Ethics

Given this project's nature as a security tool, we hold additional ethical standards:

=== Authorized Use Only
- This tool must only be used with explicit written permission
...
=== Educational Purpose
- Share knowledge and techniques for defensive purposes
- Help others understand password security
- Contribute to overall security improvement

=== Harm Prevention
- Do not use the tool to harm individuals or organizations
- Do not share cracked passwords or hashes publicly
