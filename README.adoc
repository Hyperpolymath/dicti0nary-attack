...
:experimental:
:url-github: https://github.com/hyperpolymath/dicti0nary-attack
:url-gitlab: https://gitlab.com/hyperpolymath/dicti0nary-attack
:url-bitbucket: https://bitbucket.org/hyperpolymath/dicti0nary-attack
:url-codeberg: https://codeberg.org/hyperpolymath/dicti0nary-attack

Educational dictionary attack simulation toolkit
...
dicti0nary-attack is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
